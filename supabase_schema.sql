-- Mumbai Beatbox Hub - Complete Supabase Database Schema
...
CREATE POLICY "Allow public gallery update" ON public.gallery
    FOR UPDATE TO public USING (true);

CREATE POLICY "Allow public gallery delete" ON public.gallery
...
CREATE POLICY "Allow public videos insert" ON public.videos
    FOR INSERT TO public WITH CHECK (true);

CREATE POLICY "Allow public videos update" ON public.videos
    FOR UPDATE TO public USING (true);

CREATE POLICY "Allow public videos delete" ON public.videos
    FOR DELETE TO public USING (true);
...
CREATE POLICY "Allow public members insert" ON public.members
    FOR INSERT TO public WITH CHECK (true);

CREATE POLICY "Allow public members update" ON public.members
    FOR UPDATE TO public USING (true);

CREATE POLICY "Allow public members delete" ON public.members
    FOR DELETE TO public USING (true);
...
CREATE POLICY "Allow public RSVP select" ON public.rsvps
    FOR SELECT TO public USING (true);

CREATE POLICY "Allow public RSVP insert" ON public.rsvps
    FOR INSERT TO public WITH CHECK (true);

CREATE POLICY "Allow public RSVP delete" ON public.rsvps
    FOR DELETE TO public USING (true);
...
CREATE POLICY "Allow public contact dispatch select" ON public.contact_dispatches
    FOR SELECT TO public USING (true);

CREATE POLICY "Allow public contact dispatch insert" ON public.contact_dispatches
    FOR INSERT TO public WITH CHECK (true);

CREATE POLICY "Allow public contact dispatch delete" ON public.contact_dispatches
    FOR DELETE TO public USING (true);
